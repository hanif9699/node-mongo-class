...
export class Routes {
    ...
    public routes(app: Application): void {
        ...
        app.get('/v1/getComment/:blogId', this.verifyTokenMiddlware.verifyToken.bind(this.verifyTokenMiddlware), this.blogController.getCommentByBlog.bind(this.blogController))
